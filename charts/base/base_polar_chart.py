...
class MplPolarCanvas(FigureCanvasQTAgg):
    def __init__(self, parent, nrows, ncols, width, height, dpi=100):
        self.parent = parent
        ...
        self.axs = plt.subplot(polar=True)
        plt.subplots_adjust(hspace=0.5, wspace=0.5)
        super(MplPolarCanvas, self).__init__(self.fig)


class BasePolarChart(QWidget):
    def __init__(self, parent=None, *args, **kwargs):
        super(BasePolarChart, self).__init__(parent=parent, *args, **kwargs)
        self.parent = parent
    ...
    def get_canvas(self, nrows=1, ncols=1):
        self.canvas = MplPolarCanvas(self, nrows=nrows, ncols=ncols, width=self.canvas_width, height=self.canvas_height,
                                     dpi=self.dpi)
    ...
    def get_canvas_settings(self):
        ...
        self.parent.dpi_spin.valueChanged.connect(self.dpi_spin_changed)
        # 画布颜色
    ...
    def set_x_label_and_ticks(self):
        ...
        # self.canvas.axs.xaxis.set_minor_locator(ticker.MultipleLocator(1))
        ...
        self.canvas.axs.tick_params(which="both", axis='x', direction=self.x_tick_direction,
                                    ...
                                    labelsize=self.bs_x_tick_label_size)
    ...
    def set_y_label_and_ticks(self):
        ...
        self.canvas.axs.tick_params(which="both", axis='y', direction=self.y_tick_direction,
                                    ...
                                    labelsize=self.bs_y_tick_label_size)
    ...
    # def x_label_font_changed(self, e):
    #     print(e)
    #     self.x_label_font = e
    #     # self.update_plot()

    # def x_label_font_changed1(self, e):
    #     print(e.family())
    #     print(self.parent.bs_x_font_combo.currentFont().key())
