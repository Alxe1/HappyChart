...
from widgets.ui_widgets.ui_errorbar_chart_tool import Ui_Form


class ErrorBarChartToolFrame(QFrame, Ui_Form):
    def __init__(self, parent=None, *args, **kwargs):
        super(ErrorBarChartToolFrame, self).__init__(parent=parent, *args, **kwargs)
        self.setupUi(self)
        self.parent = parent
