...
from widgets.ui_widgets.ui_hbar_chart_tool import Ui_Form


class HBarChartToolFrame(QFrame, Ui_Form):
    def __init__(self, parent=None, *args, **kwargs):
        super(HBarChartToolFrame, self).__init__(parent=parent, *args, **kwargs)
        self.parent = parent
        self.setupUi(self)
