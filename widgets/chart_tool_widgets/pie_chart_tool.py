...
from widgets.ui_widgets.ui_pie_chart_tool import Ui_Form


class PieChartToolFrame(QFrame, Ui_Form):
    def __init__(self, parent=None, *args, **kwargs):
        super(PieChartToolFrame, self).__init__(parent, *args, **kwargs)
        self.setupUi(self)
        self.parent = parent
