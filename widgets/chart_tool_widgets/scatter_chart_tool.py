...
from widgets.ui_widgets.ui_scatter_chart_tool import Ui_Form


class ScatterChartToolFrame(QFrame, Ui_Form):
    def __init__(self, parent=None, *args, **kwargs):
        super(ScatterChartToolFrame, self).__init__(parent=parent, *args, **kwargs)
        self.parent = parent
        self.setupUi(self)
