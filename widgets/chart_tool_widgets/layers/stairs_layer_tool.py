...
from widgets.ui_widgets.layers.ui_stairs_layer_tool import Ui_Form


class StairsLayerToolFrame(QFrame, Ui_Form):
    _id = None

    def __init__(self, parent=None, *args, **kwargs):
        super(StairsLayerToolFrame, self).__init__(parent=parent, *args, **kwargs)
        self.parent = parent
        self.setupUi(self)
