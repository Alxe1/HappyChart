...
################################################################################
## Form generated from reading UI file 'errorbarChartToolUIIEjYtV.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.x_err_series_combo)
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.y_err_series_combo)
        ...
        self.formLayout.setWidget(5, QFormLayout.FieldRole, self.color_series_btn)

        self.color_series_line = QLineEdit(Form)
        self.color_series_line.setObjectName(u"color_series_line")

        self.formLayout.setWidget(6, QFormLayout.FieldRole, self.color_series_line)

        self.verticalSpacer = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.formLayout.setItem(23, QFormLayout.FieldRole, self.verticalSpacer)
        ...
        self.formLayout.setWidget(7, QFormLayout.FieldRole, self.err_line_width_spin)
        ...
        self.formLayout.setWidget(8, QFormLayout.FieldRole, self.err_every_spin)
        ...
        self.formLayout.setWidget(9, QFormLayout.FieldRole, self.cap_size_spin)
        ...
        self.formLayout.setWidget(10, QFormLayout.FieldRole, self.marker_combo)
        ...
        self.formLayout.setWidget(11, QFormLayout.FieldRole, self.marker_size_spin)

        self.label_43 = QLabel(Form)
        self.label_43.setObjectName(u"label_43")

        self.formLayout.setWidget(11, QFormLayout.LabelRole, self.label_43)
        ...
        self.formLayout.setWidget(12, QFormLayout.FieldRole, self.marker_edge_width_spin)
        ...
        self.formLayout.setWidget(13, QFormLayout.FieldRole, self.marker_edge_color_btn)
        ...
        self.formLayout.setWidget(14, QFormLayout.FieldRole, self.marker_face_color_btn)
        ...
        self.formLayout.setWidget(15, QFormLayout.FieldRole, self.linestyle_combo)
        ...
        self.formLayout.setWidget(16, QFormLayout.FieldRole, self.line_color_btn)
        ...
        self.formLayout.setWidget(17, QFormLayout.FieldRole, self.line_color_line)

        self.bars_above_check = QCheckBox(Form)
        self.bars_above_check.setObjectName(u"bars_above_check")

        self.formLayout.setWidget(18, QFormLayout.FieldRole, self.bars_above_check)

        self.label_11 = QLabel(Form)
        self.label_11.setObjectName(u"label_11")

        self.formLayout.setWidget(18, QFormLayout.LabelRole, self.label_11)

        self.lower_limits_check = QCheckBox(Form)
        self.lower_limits_check.setObjectName(u"lower_limits_check")

        self.formLayout.setWidget(19, QFormLayout.FieldRole, self.lower_limits_check)

        self.label_12 = QLabel(Form)
        self.label_12.setObjectName(u"label_12")

        self.formLayout.setWidget(19, QFormLayout.LabelRole, self.label_12)

        self.upper_limits_check = QCheckBox(Form)
        self.upper_limits_check.setObjectName(u"upper_limits_check")

        self.formLayout.setWidget(20, QFormLayout.FieldRole, self.upper_limits_check)

        self.label_13 = QLabel(Form)
        self.label_13.setObjectName(u"label_13")

        self.formLayout.setWidget(20, QFormLayout.LabelRole, self.label_13)

        self.xlower_limits_check = QCheckBox(Form)
        self.xlower_limits_check.setObjectName(u"xlower_limits_check")

        self.formLayout.setWidget(21, QFormLayout.FieldRole, self.xlower_limits_check)

        self.label_14 = QLabel(Form)
        self.label_14.setObjectName(u"label_14")

        self.formLayout.setWidget(21, QFormLayout.LabelRole, self.label_14)

        self.xupper_limits_check = QCheckBox(Form)
        self.xupper_limits_check.setObjectName(u"xupper_limits_check")

        self.formLayout.setWidget(22, QFormLayout.FieldRole, self.xupper_limits_check)

        self.label_15 = QLabel(Form)
        self.label_15.setObjectName(u"label_15")

        self.formLayout.setWidget(22, QFormLayout.LabelRole, self.label_15)
