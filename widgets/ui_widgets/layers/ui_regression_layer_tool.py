...
################################################################################
## Form generated from reading UI file 'regressionLayerToolUILqvdUi.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.line_style_combo)
        ...
        self.line_transparency_slider = QSlider(Form)
        self.line_transparency_slider.setObjectName(u"line_transparency_slider")
        self.line_transparency_slider.setMaximum(100)
        self.line_transparency_slider.setValue(100)
        self.line_transparency_slider.setOrientation(Qt.Orientation.Horizontal)

        self.formLayout.setWidget(6, QFormLayout.FieldRole, self.line_transparency_slider)
        ...
        self.ci_color_series_btn = QToolButton(Form)
        self.ci_color_series_btn.setObjectName(u"ci_color_series_btn")

        self.formLayout.setWidget(7, QFormLayout.FieldRole, self.ci_color_series_btn)
        ...
        self.ci_color_series_line = QLineEdit(Form)
        self.ci_color_series_line.setObjectName(u"ci_color_series_line")

        self.formLayout.setWidget(8, QFormLayout.FieldRole, self.ci_color_series_line)

        self.ci_transparency_slider = QSlider(Form)
        self.ci_transparency_slider.setObjectName(u"ci_transparency_slider")
        self.ci_transparency_slider.setMaximum(100)
        self.ci_transparency_slider.setValue(100)
        self.ci_transparency_slider.setOrientation(Qt.Orientation.Horizontal)

        self.formLayout.setWidget(9, QFormLayout.FieldRole, self.ci_transparency_slider)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Regression Layer", None))
        ...
        self.label_16.setText(QCoreApplication.translate("Form", u"LineTransparency", None))
        self.ci_color_series_btn.setText("")
        self.label_2.setText(QCoreApplication.translate("Form", u"CIColorSeries", None))
        self.label_3.setText(QCoreApplication.translate("Form", u"CITransparency", None))
    # retranslateUi
