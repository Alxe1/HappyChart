...
################################################################################
## Form generated from reading UI file 'stairsLayerToolUIqyEtDP.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.orientation_combo)
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.base_line_spin)
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.line_width_spin)
        ...
        self.formLayout.setWidget(5, QFormLayout.FieldRole, self.line_style_combo)
        ...
        self.formLayout.setWidget(6, QFormLayout.FieldRole, self.fill_color_check)
        ...
        self.formLayout.setWidget(7, QFormLayout.FieldRole, self.edge_color_series_btn)

        self.edge_color_series_line = QLineEdit(Form)
        self.edge_color_series_line.setObjectName(u"edge_color_series_line")

        self.formLayout.setWidget(8, QFormLayout.FieldRole, self.edge_color_series_line)
        ...
        self.formLayout.setWidget(9, QFormLayout.FieldRole, self.face_color_series_btn)

        self.face_color_series_line = QLineEdit(Form)
        self.face_color_series_line.setObjectName(u"face_color_series_line")

        self.formLayout.setWidget(10, QFormLayout.FieldRole, self.face_color_series_line)

        self.label_16 = QLabel(Form)
        self.label_16.setObjectName(u"label_16")

        self.formLayout.setWidget(11, QFormLayout.LabelRole, self.label_16)
        ...
        self.formLayout.setWidget(11, QFormLayout.FieldRole, self.transparency_slider)

        self.label_17 = QLabel(Form)
        self.label_17.setObjectName(u"label_17")

        self.formLayout.setWidget(12, QFormLayout.LabelRole, self.label_17)

        self.hatch_series_line = QLineEdit(Form)
        self.hatch_series_line.setObjectName(u"hatch_series_line")

        self.formLayout.setWidget(12, QFormLayout.FieldRole, self.hatch_series_line)

        self.verticalSpacer = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.formLayout.setItem(13, QFormLayout.FieldRole, self.verticalSpacer)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_6.setText(QCoreApplication.translate("Form", u"Stairs Layer", None))
