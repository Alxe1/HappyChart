...
################################################################################
## Form generated from reading UI file 'lineLayerToolUIFpzOBG.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.y_series_combo.setMinimumSize(QSize(0, 0))
        self.y_series_combo.setMaximumSize(QSize(200, 16777215))
        ...
        self.formLayout.setItem(18, QFormLayout.FieldRole, self.verticalSpacer)

        self.line_color_series_btn = QToolButton(Form)
        self.line_color_series_btn.setObjectName(u"line_color_series_btn")

        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.line_color_series_btn)
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.line_color_series_line)

        self.line_type_series_line = QLineEdit(Form)
        self.line_type_series_line.setObjectName(u"line_type_series_line")

        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.line_type_series_line)
        ...
        self.formLayout.setWidget(6, QFormLayout.FieldRole, self.line_marker_series_line)
        ...
        self.formLayout.setWidget(7, QFormLayout.FieldRole, self.line_marker_size_spin)
        ...
        self.formLayout.setWidget(8, QFormLayout.FieldRole, self.line_path_check)
        ...
        self.formLayout.setWidget(9, QFormLayout.FieldRole, self.line_path_interval_spin)
        ...
        self.formLayout.setWidget(10, QFormLayout.FieldRole, self.line_path_angle_spin)
        ...
        self.formLayout.setWidget(11, QFormLayout.FieldRole, self.line_value_label_check)
        ...
        self.formLayout.setWidget(12, QFormLayout.FieldRole, self.line_value_label_horiz_pos_combo)

        self.label_21 = QLabel(Form)
        self.label_21.setObjectName(u"label_21")

        self.formLayout.setWidget(12, QFormLayout.LabelRole, self.label_21)
        ...
        self.formLayout.setWidget(13, QFormLayout.FieldRole, self.line_value_label_vertic_pos_combo)
        ...
        self.formLayout.setWidget(14, QFormLayout.FieldRole, self.line_value_label_interval_spin)
        ...
        self.formLayout.setWidget(15, QFormLayout.FieldRole, self.line_value_label_color_series_btn)
        ...
        self.formLayout.setWidget(16, QFormLayout.FieldRole, self.line_value_label_color_series_line)
        ...
        self.formLayout.setWidget(17, QFormLayout.FieldRole, self.line_value_label_size_spin)

        self.label_24 = QLabel(Form)
        self.label_24.setObjectName(u"label_24")

        self.formLayout.setWidget(17, QFormLayout.LabelRole, self.label_24)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_8.setText(QCoreApplication.translate("Form", u"Line Layer", None))
        ...
        self.label_11.setText(QCoreApplication.translate("Form", u"LineColorSeries", None))
        ...
        self.label_13.setText(QCoreApplication.translate("Form", u"MarkerTypeSeries", None))
